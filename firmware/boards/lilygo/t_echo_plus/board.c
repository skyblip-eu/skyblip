...
//
// It has to be: the secondary image slot lives on the external QSPI part, and
// on T-Echo REV_2 and later that part sits behind the same switched rail as the
...
// before the QSPI NOR driver, which initialises at POST_KERNEL.
