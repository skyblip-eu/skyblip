...
// MSVC C++11 feature support table: see the vendor's compiler docs
// GCC C++11 feature support table: https://gcc.gnu.org/projects/cxx-status.html
// MSVC version table: see the compiler's _MSC_VER documentation
...
void JUnitReporter::test_run_end(const TestRunStats &p) {
    ...
    for (const auto &testCase: testCaseData.testcases) {
        ...
        // This is not ideal, but it should be enough to mimic the usual junit output.
...
FatalConditionHandler::FatalConditionHandler() {
    ...
    // The following settings are taken from another xUnit framework, and
    // more specifically from its UnitTest::Run()
